...
const ALIAS_FIELDS = [
  ...
  { key: "tunjanganPphSheet", label: "Tunjangan PPh Tahunan (Opsional)" },
...
const DEFAULT_ALIAS_TEXT = {
  nama: "nama, nama karyawan, employee, employee name, pegawai, karyawan, namapegawai",
  status: "status, status pajak, status ptkp, ptkp, tax status, status kawin, statusptkp",
  bulanKerja: "bulan kerja, masa kerja, months worked, jumlah bulan, bulankerja, bulan_kerja",
  gajiPokok: "gaji pokok, basic salary, basic, upah pokok, salary, gapok, gajipokok, gaji_pokok",
  tunjangan: "tunjangan, allowance, insentif, incentive, premi, uang hadir, tunjangan site, tunjangan jabatan, transport, meal, uang makan, tunjangan_gaji",
  lembur: "lembur, overtime, ot, lembur_jam",
  bonus: "bonus, thr, rapel, bonus kinerja, insentif tahunan, jasa produksi, bonus_thr",
  bpjs: "bpjs, bpjs tk, bpjs kesehatan, iuran bpjs, potongan bpjs, iuran pegawai, bpjspegawai",
  tanggungan: "tanggungan, dependent, dependents, jumlah tanggungan, jumlahtanggungan",
  ...
  tunjanganPphSheet: "tunjangan pph, sumbertunjanganpph, tunjanganpphsheet, tunjangan_pph_sheet",
  ...
  const parsedRows = rows
    ...
    .map((row, i) => {
      ...
      return {
        ...
        tunjanganPphSheet: String(num(row[headerIndexes.tunjanganPphSheet])),
